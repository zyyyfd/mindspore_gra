...
class BaseAttack(Cell):
    ...
    def save_adj(self, root=r'/tmp/', name='mod_adj'):
        ...
        if type(modified_adj) is ms.Tensor:
            sparse_adj = mind_utils.to_scipy(modified_adj)
    ...
    def save_features(self, root=r'/tmp/', name='mod_features'):
        ...
        if type(modified_features) is ms.Tensor:
            sparse_features = mind_utils.to_scipy(modified_features)
